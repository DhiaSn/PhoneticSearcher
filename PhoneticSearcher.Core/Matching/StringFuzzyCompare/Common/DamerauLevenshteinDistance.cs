...
namespace PhoneticSearcher.Core.Matching.StringFuzzyCompare.Common
{
    ...
    public class DamerauLevenshteinDistance : StringFuzzyComparer
    {
        ...
        public override float Compare(string str1, string str2)
        {
            ...
            float distance = BuildDamerauLevenshteinDistance(str1, str2);

            return NormalizeScore(str1, str2, distance);
        }
        ...
        public int BuildDamerauLevenshteinDistance(string str1, string str2)
        {
            ...
            for (int i = 1; i <= length1; i++)
            {
                for (int j = 1; j <= length2; j++)
                {
                    ...
                    int substitionCost = (int)CostFunction.GetCost(str1, i - 1, str2, j - 1);
