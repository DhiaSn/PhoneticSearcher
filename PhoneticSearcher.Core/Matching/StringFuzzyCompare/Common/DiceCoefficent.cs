...
namespace PhoneticSearcher.Core.Matching.StringFuzzyCompare.Common
{
    ...
    public class DiceCoefficent : StringFuzzyComparer
    {
        ...
        public override float Compare(string str1, string str2)
        {
            ...
            string[] ngrams1 = tokenizer.Tokenize(str1.ToLower());

            // "Meier" -> #M Me ei ie er r#
            string[] ngrams2 = tokenizer.Tokenize(str2.ToLower());

            float dice = BuildDiceCoefficient(ngrams1, ngrams2);

            return NormalizeScore(str1, str2, dice);
        }
