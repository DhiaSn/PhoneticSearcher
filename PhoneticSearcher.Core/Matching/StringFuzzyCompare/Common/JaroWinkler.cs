...
namespace PhoneticSearcher.Core.Matching.StringFuzzyCompare.Common
{
    public class JaroWinkler : StringFuzzyComparer
    {
        ...
        public override float Compare(string str1, string str2)
        {
            ...
            float score = BuildJaroWinkler(str1, str2);

            return NormalizeScore(str1, str2, score);
        }
        ...
        public float BuildJaroWinkler(string str1, string str2)
        {
            ...
            StringBuilder common1 = GetCommonCharacters(str1, str2, matchRange);
            StringBuilder common2 = GetCommonCharacters(str2, str1, matchRange);
            ...
            float jaroWinklerSimilarity = jaroSimilarity <= boostThreshold
                                       ? jaroSimilarity
                                       : jaroSimilarity + 0.1f * GetCommonPrefix(str1, str2) * (1.0f - jaroSimilarity);
