    ...
    public class Metaphone : StringPhoneticKeyBuilder
    {
        ...
        private string BuildMetaphone(string str1)
        {
            ...
            if (!string.IsNullOrEmpty(str1) && str1.Length >= 2)
                BeginningOfWordChecks(str1, encodingBuilder, ref charIndex);
            ...
            while (charIndex < str1.Length)
            {
                ...
                {
                    if (nextChar == 'H' && !(IsVowel(afterNextChar) || charIndex == str1.Length))
                        charIndex++;
                    else if (nextChar == 'N')
                    {
                ...
                if (encodingBuilder.Length == MaxLength)
                    break;
